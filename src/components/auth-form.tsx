...
export function AuthForm({ allowRegistration = true, defaultCallbackURL = "/", heading }: { allowRegistration?: boolean; defaultCallbackURL?: string; heading?: string } = {}) {
  ...
  const callbackURL = requestedCallback?.startsWith("/") && !requestedCallback.startsWith("//") ? requestedCallback : defaultCallbackURL;
