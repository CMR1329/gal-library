...
import type { ProfileMediaOverviewEntry } from "@/lib/profile-data";
...
export function ProfileMediaOverview({ entry, profilePath, backLabel, actions }: { entry: ProfileMediaOverviewEntry; profilePath: string; backLabel: string; actions?: ReactNode }) {
  ...
  return <div className="space-y-6">
    <Link href={profilePath} className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-white"><ArrowLeft className="size-4" />{backLabel}</Link>
