  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const result = mode === "login"
        ...
        : await authClient.signUp.email({ name: String(data.get("name") || "").trim(), email, password, username } as Parameters<typeof authClient.signUp.email>[0]);
